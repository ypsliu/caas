...
--
-- Dumping data for table `caas_admin_user`
--

LOCK TABLES `caas_admin_user` WRITE;
/*!40000 ALTER TABLE `caas_admin_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `caas_admin_user` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `caas_app`
--

LOCK TABLES `caas_app` WRITE;
/*!40000 ALTER TABLE `caas_app` DISABLE KEYS */;
/*!40000 ALTER TABLE `caas_app` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `caas_app_setting`
--

LOCK TABLES `caas_app_setting` WRITE;
/*!40000 ALTER TABLE `caas_app_setting` DISABLE KEYS */;
/*!40000 ALTER TABLE `caas_app_setting` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `caas_resource`
--

LOCK TABLES `caas_resource` WRITE;
/*!40000 ALTER TABLE `caas_resource` DISABLE KEYS */;
/*!40000 ALTER TABLE `caas_resource` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `caas_role`
--

LOCK TABLES `caas_role` WRITE;
/*!40000 ALTER TABLE `caas_role` DISABLE KEYS */;
/*!40000 ALTER TABLE `caas_role` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `caas_role_resource`
--

LOCK TABLES `caas_role_resource` WRITE;
/*!40000 ALTER TABLE `caas_role_resource` DISABLE KEYS */;
/*!40000 ALTER TABLE `caas_role_resource` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `caas_user`
--

LOCK TABLES `caas_user` WRITE;
/*!40000 ALTER TABLE `caas_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `caas_user` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `caas_user_role`
--

LOCK TABLES `caas_user_role` WRITE;
/*!40000 ALTER TABLE `caas_user_role` DISABLE KEYS */;
/*!40000 ALTER TABLE `caas_user_role` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-09-05 16:07:53
