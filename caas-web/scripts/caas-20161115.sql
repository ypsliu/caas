...
) ENGINE=InnoDB AUTO_INCREMENT=245 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='资源表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `caas_role_resource` (
  ...
  PRIMARY KEY (`resourceCode`,`roleCode`,`operationCode`)
...
-- Dump completed on 2016-11-15 11:02:41
