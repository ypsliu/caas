...
CREATE TABLE `caas_app` (
  ...
  PRIMARY KEY (`code`),
  UNIQUE KEY `index_name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=1474118112189 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='应用程序表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='资源表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `caas_role` (
  ...
  PRIMARY KEY (`code`),
  KEY `appcode_name` (`appCode`,`name`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='角色表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-09-23 13:26:30
