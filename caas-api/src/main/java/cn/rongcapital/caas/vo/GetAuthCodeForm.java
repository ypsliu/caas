...
/**
 * the getAuthCode form
 * 
 * @author shangchunming@rongcapital.cn
 *
 */
public final class GetAuthCodeForm extends BaseSignedForm {
	...
	public String toString() {
		return "GetAuthCodeForm [accessToken=" + accessToken + ", appKey=" + appKey + ", timestamp=" + timestamp
				+ ", sign=" + sign + "]";
	}
