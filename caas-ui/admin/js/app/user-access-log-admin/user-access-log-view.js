define(["text!app/user-access-log-admin/user-access-log-tpl.html",
    ...
    return Backbone.View.extend({
        ...
        render: function (event) {
            ...
            // }));
            require(["app/constants", "app/components/admin-user"], function(con,adminUser) {
        ...
        buildPath : function(condition) {
            var path = "#admin/user-access-log";
            for(var key in condition) {
